...
Chocobo::Chocobo(int xCord, int yCord, int skill_rates[]){
 ...
 void Chocobo::setProperties(int scaling[]) {
    ...
    this->attributes.damage[1] = (scaling[0]*MAX_DAMAGE.chocobo)/10;
    ...
    this->attributes.distance[1] = (scaling[1]*MAX_DISTANCE.chocobo)/10;
    ...
    this->attributes.health[1] = (scaling[2]*MAX_HEALTH.chocobo)/10;
    ...
    this->attributes.range[1] = (scaling[3]*MAX_RANGE.chocobo)/10;
    ...
    this->attributes.route_size[1] = (scaling[4]*MAX_ROUTE_SIZE.chocobo)/10;
    ...
    this->attributes.speed[1] = (scaling[0]*MAX_SPEED.chocobo)/10;
